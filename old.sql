...
CREATE TABLE `img`  (
  ...
  `height` int(11) NOT NULL DEFAULT 0 COMMENT '高',
  `img_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片名',
  `path` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片访问路径',
  `width` int(11) NOT NULL DEFAULT 0 COMMENT '宽',
  `img_gather_id` int(11) NULL DEFAULT NULL,
  `title` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标题',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKqk83gf46qo7kfuxaivstyerf5`(`img_gather_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of img
-- ----------------------------
INSERT INTO `img` VALUES (26, '2018-11-24 19:15:06', '', 14, 548, 'water_5bc6f61f49bcb.jpg ', 'http://localhost:8080/image/water_5bc6f61f49bcb.jpg', 357, 4, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (25, '2018-11-24 19:15:06', '', 1, 626, 'water_5bc6f61e086c6.jpg ', 'http://localhost:8080/image/water_5bc6f61e086c6.jpg', 440, 3, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (24, '2018-11-24 19:15:06', '', 0, 510, 'water_5bc6f61d69ed6.jpg', 'http://localhost:8080/image/water_5bc6f61d69ed6.jpg', 571, 3, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (23, '2018-11-24 19:15:06', '', 1, 232, '111.gif', 'http://localhost:8080/image/111.gif', 180, 2, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (22, '2018-11-24 19:15:06', '', 0, 249, '5b08f5520989e.gif', 'http://localhost:8080/image/5b08f5520989e.gif', 250, 2, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (21, '2018-11-24 19:15:06', '', 0, 345, '5b08f58033bf2.gif', 'http://localhost:8080/image/5b08f58033bf2.gif', 259, 2, 'xvds士大夫是非得失');
INSERT INTO `img` VALUES (20, '2018-11-24 19:15:06', '', 2, 180, '5b08f57041ad2.gif', 'http://localhost:8080/image/5b08f57041ad2.gif', 400, 1, '色发射点犯得上犯得上发');
INSERT INTO `img` VALUES (19, '2018-11-24 19:15:06', '', 0, 264, '5b08f5601d134.gif', 'http://localhost:8080/image/5b08f5601d134.gif', 200, 1, '的发生发生发射点');
INSERT INTO `img` VALUES (27, '2018-11-24 19:15:06', '', 29, 333, 'water_5bc6f6159a6b1.jpg ', 'http://localhost:8080/image/water_5bc6f6159a6b1.jpg', 568, 4, 'x服务五日u您尽快');
INSERT INTO `img` VALUES (28, '2018-11-24 19:25:54', NULL, 0, 264, '20181124192554_5b08f5601d134.gif', 'http://localhost:8080/image/20181124192554_5b08f5601d134.gif', 200, NULL, NULL);

-- ----------------------------
-- Table structure for img_cat
-- ----------------------------
...
-- Records of img_cat
-- ----------------------------
INSERT INTO `img_cat` VALUES (1, '2018-11-24 10:33:18', '', '搞笑GIF');
INSERT INTO `img_cat` VALUES (2, '2018-11-24 10:33:18', '', '搞笑囧图');
INSERT INTO `img_cat` VALUES (3, '2018-11-24 13:27:43', '', '傻猫傻狗');
INSERT INTO `img_cat` VALUES (4, '2018-11-24 13:27:43', '', '美图欣赏');

-- ----------------------------
-- Table structure for img_gather
-- ----------------------------
DROP TABLE IF EXISTS `img_gather`;
CREATE TABLE `img_gather`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `number` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '序列号',
  `check_status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '审核状态',
  `img_cat_id` int(11) NOT NULL DEFAULT 0 COMMENT '图集分类id',
  `img_num` int(11) NOT NULL DEFAULT 0 COMMENT '图片数量',
  `show_status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '显示状态',
  `good_num` int(11) NULL DEFAULT 0 COMMENT '点赞总数量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of img_gather
-- ----------------------------
INSERT INTO `img_gather` VALUES (1, '2018-11-24 16:58:17', '', 1, 1, 2, 1, 2);
INSERT INTO `img_gather` VALUES (2, '2018-11-24 16:58:17', '', 1, 1, 3, 1, 1);
INSERT INTO `img_gather` VALUES (3, '2018-11-24 16:58:17', '', 1, 2, 2, 1, 1);
INSERT INTO `img_gather` VALUES (4, '2018-11-24 16:58:17', '', 1, 2, 2, 1, 37);
...
CREATE TABLE `permission`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alias` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '权限别名，配置时显示',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '描述',
  `identity` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '权限标识',
