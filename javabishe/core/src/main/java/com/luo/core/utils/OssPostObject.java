...
public class OssPostObject {
    ...
    private String postFileName = "F:\\test\\5sfdsfds.mp4";  // 确保运行代码的路径中有该文件
    private String ossEndpoint = "https://oss-cn-shenzhen.aliyuncs.com";  // 如: http://oss-cn-shanghai.aliyuncs.com
    private String ossAccessId = "LTAI7Y137y05BxnR";  // 你的访问AK信息
    private String ossAccessKey = "LTAI7Y137y05BxnR";  // 你的访问AK信息
    private String objectName = "5555555555555";  // 你上传文件之后的object名称
    private String bucket = "luo20181213";  // 你之前创建的bucket，确保这个bucket已经创建
