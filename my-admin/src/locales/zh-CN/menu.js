export default {
  ...
  'menu.sysusermanager':'系统用户',
  'menu.sysusermanager.userlist':'用户列表',
  'menu.sysusermanager.rolelist':'角色列表',
  'menu.contentmanager':'内容管理',
  'menu.contentmanager.videolist':'视频列表',
  'menu.contentmanager.videolist.videoinfo':'视频详细信息',
  'menu.contentmanager.bigimg':'大图片',
